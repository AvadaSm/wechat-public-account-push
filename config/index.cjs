...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wx18d3eaefbe33b8ee',

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: '5f3340292e29dbb8c9b6653e210c9efc',
  ...
  USERS: [
    {
      ...
      id: 'ou3Y56_ln29zvcAygEIsEBWdtDzQ',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: 'Plttn7tM5mnG6Qk57JJ4FOJsSUucKSTrq38HJ597-wU',
      // 所在省份
      province: '浙江',
      // 所在城市
      city: '杭州',
      ...
      festivals: [
        ...
        {
          type: '*生日', name: '刘昊坤', year: '2001', date: '01-23',
        },
        /*{
        ...
        {
          type: '*生日', name: '方可欣', year: '2004', date: '09-09',
        }
      ],
      // 专属纪念日/倒数日，如果你在这里填写了纪念日/倒数日，就不会计算CUSTOMIZED_DATE_LIST的日子了, 和CUSTOMIZED_DATE_LIST的配置方法相同，可以往下查看，我这里就不重复写了
      customizedDateList: [
        // 在一起的日子
        { keyword: 'love_day', date: '2020-03-04' },
        // 结婚纪念日
  ...
  CALLBACK_TEMPLATE_ID: 'ksmdvQ7NdcfEWYKXeVwTIwx1XidirgUcfzvjT5Bo1nQ',
